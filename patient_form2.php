    ...
    <div class="row">
        <div class="col-md col-lg-3">
            <div class="form-group">
                ...
                <div class="custom-control custom-radio">
                    <input class="custom-control-input" type="radio" name="cigarette" id="cigarette3">
        ...
        <div class="col-md col-lg-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="doctor_name" name="doctor_name" value="แพทย์เวชปฎิบัติ">
            </div>
        </div>
    </div>
    <div class="row">
